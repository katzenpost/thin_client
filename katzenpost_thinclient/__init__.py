...
ThinClient.start_resending_encrypted_message_return_box_exists = (
    start_resending_encrypted_message_return_box_exists
)
ThinClient.start_resending_encrypted_message_no_retry = (
    start_resending_encrypted_message_no_retry
)
...
ThinClient.create_courier_envelopes_from_tombstone_range = (
    create_courier_envelopes_from_tombstone_range
)
